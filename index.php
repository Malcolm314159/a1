...
<body>
  ...
  <h2>About Me</h2>
  <p>I'm an aspiring developer currently working full time at SunBug Solar in Arlington Massachusetts. I'm the administrator for all of SunBug's monitoring systems. I introduce customers to data acquisition systems, provide technical support, and travel across the state troubleshooting dataloggers and smart meters! I'm a passionate environmentalist, so I love working for a company that installs solar on the roofs of Massachusetts' buildings.</p>
